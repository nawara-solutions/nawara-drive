...
> this repo's test-writing practices (including e2e) live under
> [`e2e/README.md`](../../e2e/README.md) and future unit/integration test docs.
...
_None yet — add an entry here as TDDs are written._
